        ...
        <div className="px-4 py-6 sm:px-0">
          ...
          <div className="mt-6 bg-white p-4 rounded-md shadow">
            ...
            <ul className="list-disc pl-5 space-y-2 text-sm text-gray-600">
              <li>Click &ldquo;Active/Inactive&rdquo; to toggle whether a service appears on the website</li>
              <li>Use the Edit button to modify service details</li>
              <li>Click &ldquo;Add New Service&rdquo; to create a new service offering</li>
