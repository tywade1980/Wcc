        ...
        <div className="px-4 py-6 sm:px-0">
          ...
          <div className="mt-6 bg-white p-4 rounded-md shadow">
            ...
            <ul className="list-disc pl-5 space-y-2 text-sm text-gray-600">
              ...
              <li>Click &ldquo;Featured&rdquo; to toggle whether a project appears on the homepage</li>
              <li>Use the Edit button to modify project details and images</li>
              <li>Click &ldquo;Add New Project&rdquo; to create a new portfolio entry</li>
            </ul>
          </div>
        </div>
      </main>
