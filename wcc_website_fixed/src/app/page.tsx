        ...
        <div className="container mx-auto text-center max-w-4xl">
          ...
          {testimonials.map(testimonial => (
            <div key={testimonial.id} className="bg-white p-8 rounded-lg shadow-lg relative">
              <span className="absolute top-4 left-4 text-6xl text-orange-300 opacity-50 font-serif">&ldquo;</span>
              <blockquote className="text-gray-600 italic text-lg mb-4">
                {testimonial.quote}
              </blockquote>
              <p className="font-semibold text-gray-800">{testimonial.name}</p>
              <p className="text-sm text-gray-500">{testimonial.location}</p>
              <span className="absolute bottom-4 right-4 text-6xl text-orange-300 opacity-50 font-serif">&rdquo;</span>
            </div>
          ))}
        </div>
      </section>
